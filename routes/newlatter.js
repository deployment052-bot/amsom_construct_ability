      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <tr>
          <td bgcolor="#21467d" style="padding: 20px 30px; text-align: center;">
            <h2 style="color: #ffffff; font-size: 20px; margin: 10px 0 0;">AMSOM Construct ability Pvt. Ltd.</h2>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 15px; color: #333333; line-height: 1.5;">
              You’ve successfully subscribed to AMSOM Construct ability. You’ll now receive the latest news, updates, and offers straight to your inbox.
            </p>
            <p style="font-size: 15px; color: #333333; line-height: 1.5;">
        ...
        <tr>
          <td style="padding: 0 30px 30px 30px; text-align: center;">
            <a href="https://amsomconstructability.netlify.app/" style="background-color: #21467d; color: #ffffff; text-decoration: none; padding: 12px 20px; border-radius: 5px; font-size: 14px;">
              Visit Our Website
            </a>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#21467d" align="center" style="padding: 15px; color: #ffffff; font-size: 13px;">
            <p style="margin: 0;">© 2025 AMSOM Construct ability Pvt. Ltd. All rights reserved.</p>
